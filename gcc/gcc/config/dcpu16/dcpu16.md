;; Machine description for dcpu16
...
(define_insn "addsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r,r")
	  (plus:SI
	   ...
	   (match_operand:SI 2 "dcpu16_add_operand" "I,N,r")))]
  ""
  "@
  inc    %0, %2
  dec	 %0, -%2
...
(define_insn "subsi3"
  [(set (match_operand:SI 0 "register_operand" "=r,r")
	  (minus:SI
	   ...
	   (match_operand:SI 2 "dcpu16_sub_operand" "I,r")))]
  ""
  "@
  dec    %0, %2
  sub.l  %0, %2")
...
(define_insn "*movsi"
  [(set (match_operand:SI 0 "general_operand" "=r,r,r,W,A,r,r,B,r")
	(match_operand:SI 1 "dcpu16_general_movsrc_operand" "O,r,i,r,r,W,A,r,B"))]
...
;;        (zero_extend:SI (match_operand:QI 1 "dcpu16_general_movsrc_operand" "W")))]
;;   "register_operand (operands[0], SImode)"
...
;;   [(set (match_operand:SI 0 "register_operand" "=r,r,r")
;;         (zero_extend:SI (match_operand:QI 1 "dcpu16_load_source_operand" "W,A,B")))]
;;     ""
;;     "@
;;     ld.b    %0, %1 # zero extended
...
(define_insn "*movqi"
  [(set (match_operand:QI 0 "general_operand" "=r,r,r,W,A,r,r,B,r")
	(match_operand:QI 1 "dcpu16_general_movsrc_operand" "O,r,i,r,r,W,A,r,B"))]
...
(define_insn "*movhi"
  [(set (match_operand:HI 0 "general_operand" "=r,r,r,W,A,r,r,B,r")
	(match_operand:HI 1 "dcpu16_general_movsrc_operand" "O,r,i,r,r,W,A,r,B"))]
