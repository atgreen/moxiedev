...
#ifndef _ASM_MOXIE_PAGE_H
#define _ASM_MOXIE_PAGE_H
 ...
 *
 * CONFIG_KERNEL_START is defined in arch/moxie/config.in and used
 * in arch/moxie/Makefile.
 */
...
/* Handle Moxie processor with virtual memory. */
#ifndef CONFIG_MMU
