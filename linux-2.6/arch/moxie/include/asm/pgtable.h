...
#ifndef _ASM_MOXIE_PGTABLE_H
#define _ASM_MOXIE_PGTABLE_H
...
/*
 * The Moxie MMU is identical to the PPC-40x MMU, and uses a hash
...
/*
 * The Moxie processor has a TLB architecture identical to PPC-40x. The
