/*
 * include/asm-moxie/io.h -- Misc I/O operations
 *
 *  Copyright (C) 2009     Anrhony Green <green@moxielogic.com>
 ...
 * Moxie port by John Williams
 */

#ifndef __MOXIE_IO_H__
#define __MOXIE_IO_H__
