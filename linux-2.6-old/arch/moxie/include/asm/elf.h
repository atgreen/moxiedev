 ...
 * I've snaffled the value from the moxie binutils source code
 * /binutils/moxie/include/elf/moxie.h
 */
#define EM_XILINX_MOXIE	0xbaab
#define ELF_ARCH		EM_XILINX_MOXIE

/*
 * This is used to ensure we don't load something for the wrong architecture.
 */
#define elf_check_arch(x)	((x)->e_machine == EM_XILINX_MOXIE)
