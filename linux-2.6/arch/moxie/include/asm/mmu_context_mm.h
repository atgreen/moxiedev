...
#ifndef _ASM_MOXIE_MMU_CONTEXT_H
#define _ASM_MOXIE_MMU_CONTEXT_H
...
/*
   Moxie has 256 contexts, so we can just rotate through these
...
# endif /* __KERNEL__ */
#endif /* _ASM_MOXIE_MMU_CONTEXT_H */
